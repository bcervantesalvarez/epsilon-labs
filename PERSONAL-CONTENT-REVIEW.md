...
Brian clarified the firsthand encounter account: three well-geared players, Russet and Infernal, and Webber/Fiery/Bulwark/Lifesteal together. Fiery set players on fire; no direct 50% multiplier is claimed. Bulwark's roughly 50% negation and apparent near-full healing remain recollections, not verified measurements. Russet is confirmed in Brian’s firsthand account, not independently verified logs. The revised four-target model gives 1,739/164,450 = 1.057464% given Infernal (one in 94.6). An independent exhaustive toy check matches 2,088/20,160; a 200,000-trial seed-7 permutation simulation gives 2,124 successes (1.062%, approximate 95% interval 1.01708%–1.10692%). Under the original assumed 1/22 variant probability, 1/1,000 tier gates, and variant independence, the full four-target joint probability is 1,739/3,617,900,000 = 0.0000480666%, reciprocal 2,080,449. The original three-target result remains clearly separate. Work date is the analysis date, not the encounter date; the supplied account is not signoff.
...
Brian's request for at least three additional strong 2024 blog projects supersedes the unnamed presentation slot. Candidate audit is in progress separately; this correction does not assume candidate selections. Existing presentations, design, and Dregora case study are preserved. No production deployment.
